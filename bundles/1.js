...
"use strict";var regl=require("regl")(),draw=regl({vert:"\n    precision mediump float;\n    attribute vec2 position;\n    attribute vec3 color;\n    uniform float angle;\n    uniform vec2 offset;\n    uniform vec2 translate;\n    varying vec3 fcolor;\n    void main() {\n      fcolor = color;\n      gl_Position = vec4(\n        cos(angle) * position.x + sin(angle) * position.y + offset.x + translate.x,\n        -sin(angle) * position.x + cos(angle) * position.y + offset.y + translate.y,\n        0,\n        1\n      );\n    }\n  ",frag:"\n    precision mediump float;\n    varying vec3 fcolor;\n    void main() {\n      gl_FragColor = vec4(fcolor, 1);\n    }\n  ",attributes:{position:[.5,0,0,.5,1,1],color:function(n,t,o){var e=n.tick;return[[Math.sin(.02*((.1+Math.sin(o))*e+3*o)),Math.cos(.02*(.02*e+.1*o)),Math.sin(.02*((.3+Math.cos(2*o))*e+.8*o))],[Math.sin(.02*((.3+Math.cos(2*o))*e+.8*o)),Math.sin(.02*((.1+Math.sin(o))*e+3*o)),Math.cos(.02*(.02*e+.1*o))],[Math.cos(.02*(.02*e+.1*o)),Math.sin(.02*((.1+Math.sin(o))*e+3*o)),Math.sin(.02*((.3+Math.cos(2*o))*e+.8*o))]]}},uniforms:{angle:function(n){return.01*n.tick},offset:regl.prop("offset"),translate:function(n,t,o){var e=n.tick;return[Math.cos(.005*e*(o+1)),Math.sin(.005*e*(o+1))]}},depth:{enable:!1},count:3});regl.frame(function(){regl.clear({color:[0,0,0,1]}),draw([{offset:[-1,-1]},{offset:[-1,0]},{offset:[-1,1]},{offset:[0,-1]},{offset:[0,0]},{offset:[0,1]},{offset:[1,-1]},{offset:[1,0]},{offset:[1,1]}])});
